...
library/ft_lstadd_front_bonus.c library/ft_lstlast_bonus.c library/ft_lstnew_bonus.c  signals.c\
...
CC = cc
NAME = minishell
READLINE =  -fsani tize=address -lreadline -L /Users/ael-hiou/goinfre/.brew/opt/readline/lib -I /Users/ael-hiou/goinfre/.brew/opt/readline/include
# 
SRC_O = $(SRC:.c=.o)
