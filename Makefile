...
parsing/errors_handling/errors_handling.c library/global_issues.c parsing/expanding/expanding.c parsing/expanding/expanding_utils.c parsing/here_doc/here_doc_expanding.c parsing/here_doc/here_doc.c \
...
>>>>>>> 5d3793a91267cdf183e87581831f9190101ddfbb
#  -fsanitize=address
SRC_O = $(SRC:.c=.o)
# 
all :$(NAME)
