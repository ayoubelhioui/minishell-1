...
library/ft_export_utils.c library/ft_split_equ.c library/ft_free_list.c
CC = cc
# CFLAGS = -Wextra -Werror -Wall
NAME = minishell
READLINE = -lreadline -L ~/goinfre/.brew/opt/readline/lib -I ~/goinfre/.brew/opt/readline/include -g
SRC_O = $(SRC:.c=.o)
